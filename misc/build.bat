...
del *.pdb
cl  %COMPILER_FLAGS% ..\\code\\hy3d_engine.cpp -Fmhy3d_engine.map -link -incremental:no -opt:ref  -PDB:hy3d_engine_%date:~-4,4%%date:~-10,2%%date:~-7,2%_%time:~0,2%%time:~3,2%%time:~6,2%.pdb -EXPORT:UpdateAndRender
